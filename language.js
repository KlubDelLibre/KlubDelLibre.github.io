(() => {
  ...
  const jornadasEntries = [
    ...
    },
    {
      ...
      html: '<span class="j-hora">10-13 H</span> Presentation of the proposals received and an open mic for anyone who wishes to take part, with no formal, academic or structural requirements.',
    },
    {
      selector: ".j-franjas p:nth-child(2)",
      html: '<span class="j-hora">18-22 H · closing session</span> Because speculative thought cannot be separated from sensitive, embodied experience, the conference closes by crossing the line between theory and flesh through bodily dispersion and sonic excess: an afternoon session with DJ set and performance.',
    },
